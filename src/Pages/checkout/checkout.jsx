...
const Checkout = () => {
  ...
  const checkLogin = async () => {
    const res = await fetch("https://e-commerce-backend-self-five.vercel.app/info", {
      method: "GET",
      credentials: "include",
    });
  ...
  {
    const res = await fetch("https://e-commerce-backend-self-five.vercel.app/api/orders", {
      method: "POST",
      credentials: "include",
      headers: {
  ...
  const handleRazorpayPayment = async () => 
    {
      ...
      try 
      {
        ...
        ("https://e-commerce-backend-self-five.vercel.app/api/payment/create-order",
          {
            method: "POST",
    credentials: "include",
        ...
        const options = 
        {
          ...
          {
            const verifyRes = await fetch( "https://e-commerce-backend-self-five.vercel.app/api/payment/verify-payment",
              {
                method: "POST",
                headers: { "Content-Type": "application/json" },
