...
const OrderDetails = () => {
  ...
  useEffect(() => {
    const fetchOrderDetails = async () => {
      try {
        const res = await axios.get(`https://e-commerce-backend-self-five.vercel.app/api/orders/${orderId}`, {
  ...
  const handleExchange = async () => {
    ...
    try {
      await axios.put(`https://e-commerce-backend-self-five.vercel.app/api/orders/${orderId}/update-status`, 
